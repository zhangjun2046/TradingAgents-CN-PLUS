...
class ImprovedHKStockProvider:
    ...
    def __init__(self):
        ...
        self.hk_stock_names = {
            ...
            '1810.HK': '小米集团', '1810': '小米集团', '01810': '小米集团',
            '0992.HK': '联想集团', '0992': '联想集团', '00992': '联想集团',
            '0981.HK': '中芯国际', '0981': '中芯国际', '00981': '中芯国际',
            '9999.HK': '网易', '9999': '网易', '09999': '网易',
            '3888.HK': '金山软件', '3888': '金山软件', '03888': '金山软件',
            '2382.HK': '舜宇光学科技', '2382': '舜宇光学科技', '02382': '舜宇光学科技',

            # 新能源车
            '2015.HK': '理想汽车', '2015': '理想汽车', '02015': '理想汽车',
            '9868.HK': '小鹏汽车', '9868': '小鹏汽车', '09868': '小鹏汽车',
            '9866.HK': '蔚来', '9866': '蔚来', '09866': '蔚来',
            '0175.HK': '吉利汽车', '0175': '吉利汽车', '00175': '吉利汽车',

            # 交易所与综合
            '0388.HK': '香港交易所', '0388': '香港交易所', '00388': '香港交易所',
            '0001.HK': '长和', '0001': '长和', '00001': '长和',
            '6030.HK': '中信证券', '6030': '中信证券', '06030': '中信证券',

            # 运动服饰
            '2020.HK': '安踏体育', '2020': '安踏体育', '02020': '安踏体育',
            '2331.HK': '李宁', '2331': '李宁', '02331': '李宁',

            # 能源
            '0883.HK': '中国海洋石油', '0883': '中国海洋石油', '00883': '中国海洋石油',
            '1088.HK': '中国神华', '1088': '中国神华', '01088': '中国神华',

            # 医药
            '2269.HK': '药明生物', '2269': '药明生物', '02269': '药明生物',
